...
- **Recent sleep at a glance:** the sleep entry combines a Garmin score arc with seven calendar nights of duration bars. A dashed personal-median reference appears when sufficient baseline data exists. Narrow 7dp bars with small 2dp corners and taller chart areas (112dp on Home, 152dp on Sleep) make daily height differences easier to compare. The vertical scale still begins at zero. Missing nights remain gaps.
